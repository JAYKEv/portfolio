...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-lg bg-[rgb(var(--bg-elevated))] p-2 backdrop-blur-sm",
        "shadow-[0px_0.5px_1px_0px_rgba(var(--border),0.8)_inset,0px_1px_0px_0px_rgba(var(--bg),0.6)]",
        backdropBlur &&
